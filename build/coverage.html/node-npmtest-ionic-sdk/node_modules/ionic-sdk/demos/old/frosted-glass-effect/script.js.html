...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ionic-sdk/node_modules/ionic-sdk/demos/old/frosted-glass-effect/script.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-ionic-sdk/node_modules/ionic-sdk/demos/old/frosted-glass-effect/script.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ionic-sdk/node_modules/ionic-sdk/demos/old/frosted-glass-effect/</a> &#187; script.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">angular.module('starter', ['ionic', 'ionic.contrib.frostedGlass'])
&nbsp;
.controller('PageCtrl', <span class="fstat-no" title="function not covered" >function ($scope, $ionicFrostedDelegate, $ionicScrollDelegate, $rootScope) {</span>
<span class="cstat-no" title="statement not covered" >  var messageOptions = [</span>
    {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  var messageIter = 0;</span>
<span class="cstat-no" title="statement not covered" >  $scope.messages = messageOptions.slice(0, messageOptions.length);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  $scope.add = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    var nextMessage = messageOptions[messageIter++ % messageOptions.length];</span>
<span class="cstat-no" title="statement not covered" >    $scope.messages.push(angular.extend({}, nextMessage));</span>
&nbsp;
    // Update the scroll area and tell the frosted glass to redraw itself
<span class="cstat-no" title="statement not covered" >    $ionicFrostedDelegate.update();</span>
